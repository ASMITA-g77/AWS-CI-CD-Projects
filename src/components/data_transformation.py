# in the this do data transformation
...
class Transforming_Data:
    ...
    def get_data_transformer(self):
        ...
        try: 
            ...
            categorical_colmuns=["gender","race_ethnicity","parental_level_of_education","lunch","test_preparation_course"] 
            ...
            preprocessor=ColumnTransformer(
                [
                    ...
                    ("cat_pipeline",cat_pipeline,categorical_colmuns)
                ]
            )
